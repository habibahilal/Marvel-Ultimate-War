...
public  class HealingAbility extends Ability {
	...
	public String toString() {
		return ("Type: Healing Ability" + "\r\n" + super.toString() + "Healing Amount: " + this.getHealAmount() +"\r\n" +"\r\n"); 
	}
	
	public String toString2() {
		return ("Type: Healing Ability" + "; " + super.toString2() + "Healing Amount: " + this.getHealAmount() +"\r\n" +"\r\n"); 
	}
